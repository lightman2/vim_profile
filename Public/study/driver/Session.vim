...
nmap <silent> <F7> ,x
map <BS>  
map <F12> :cs find f <cword>
map <F11> :cs find s <cword>
map <F10> :cs find c <cword>
map <F9> :!make
map <F8> :!search <cword> "*" .
map <F6> :set mouse=c
map <F5> :set mouse=a
...
badd +32 123.c
badd +44 ~/.vimrc
badd +1542 ~/.vim/plugin/EnhancedCommentify.vim
badd +97 ~/.vim/plugin/mark.vim
args 123.c
edit ~/.vim/plugin/EnhancedCommentify.vim
...
wincmd w
argglobal
edit ~/.vim/doc/EnhancedCommentify.txt
setlocal noarabic
setlocal autoindent
setlocal autoread
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 417 - ((16 * winheight(0) + 8) / 17)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1542 - ((15 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1542
