...
set shortmess=aoO
badd +11 environ/cmd2.c
badd +1 include/apue.h
silent! argdel *
edit include/apue.h
...
exe 'vert 2resize ' . ((&columns * 31 + 107) / 214)
exe '3resize ' . ((&lines * 50 + 27) / 54)
exe 'vert 3resize ' . ((&columns * 182 + 107) / 214)
argglobal
enew
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((49 * winheight(0) + 25) / 50)
